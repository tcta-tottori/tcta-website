...
export const SCHEDULE = [
  ...
  { no: '10', date: '2026-08-16', label: '8月16日（日）', spareDate: '9/6', spareNote: '', spareVenue: '鳥取市千代テニス場', name: 'サマーミックスダブルス', event: 'ミックスダブルス', place: 'ヤマタスポーツパーク', due: '7/31', status: 'closed', reg: 'shi' },
